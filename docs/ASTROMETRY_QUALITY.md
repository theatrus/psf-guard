...
![Sequence quality analysis showing one off-target frame](sequence-quality-astrometry.png)
...
| --- | --- | --- |
| **Off target** | The authoritative target is outside the solved footprint, or the solved center is at least 20% of the short field dimension away | Pointing score becomes 0; total score is capped at 0.20; rejection is recommended |
| **Pointing jump** | One solved center leaves the robust dither envelope and adjacent solved frames return | Total score is capped at 0.30; rejection is recommended |
| **Pointing drift** | A robust Theil-Sen trend exceeds the field/scatter threshold after detrending | Affected tail frames are capped at 0.30; rejection is recommended |
...
weights are renormalized. The initial field-fraction thresholds are covered by
synthetic and API regression tests; calibration against additional real rigs,
mosaic panels, and deliberate reframing remains ongoing.
