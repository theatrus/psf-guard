...
PSF Guard 0.10.0 adds a Sky view that maps everything your catalogs have
pointed at, turns it as a globe, and replays it night by night, and makes
the Overview fast again on large catalogs.
