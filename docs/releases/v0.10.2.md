This release stacks projects in PixInsight's WBPP from inside PSF Guard, imports new frames on its own, writes AstroBin acquisition CSVs, and fixes previews of RGB masters.
